...
- Çizim çağrısı bütçesi: kare başına < 120, üçgen bütçesi ≤ 720 bin. **Bütçe doğuş karesinde değil, EN KÖTÜ karede
  ...
  1280×720. Tur 8 yalnız doğuş karesini ölçtü ve kuzeye yürüyen kare 747,5 bin ile tavanın üstündeydi. Tur 11'de dokuz
  karenin hepsi yeniden ölçüldü (`scratchpad/pw/r10gate.mjs <base> <saat>`, saat sabit, 45 s nüfus bekleme)
  (doğuş – 20 m – 40 m, üçgen bin / çizim): öğlen 640,2/105 – 669,6/107 – 646,4/107; 19:00 668,1/109 – 698,2/111 –
  682,0/111; 21:00 666,2/108 – 696,7/110 – 679,5/110. **En kötü 698,2 bin / 111 (19:00, 20 m kuzey.)**
  **Bağlayıcı KONUM değişti**: 19:00'da da 21:00'de de en kötü kare artık 40 m değil **20 m kuzey**; yalnız eski
  noktayı örnekleyen bir tur yanlış kareyi ölçer. Tavana kalan pay 21,8 bin üçgen (tur 10'un yazdığı ~50 bin değil)
...
- Doku üretimi ana iş parçacığını bloke eder ve ilk kareden önce ödenir: sıfır argümanlı üreticilerin toplamı
  ...
  512'ye çıkardı, +1,0 MB). Yeni bir 1024² zemin dokusu eklemeden önce bu satırı ölç.
...
npm test            # 73 birim + simülasyon testi, tarayıcı gerekmez
npm run build
