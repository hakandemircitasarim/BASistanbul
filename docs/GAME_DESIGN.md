...
Acceptance: screenshots at hours 12, 18.7, 22 look right (windows lit at night, neon on, lamps with light pools, sunset gradient); static draws ≈ 52 and the whole frame < 120 draw calls at noon (dusk 106); triangles ≤ 720k measured at the **19:00 and 21:00 spawn frames**, which carry ~18k more than noon and are the binding constraint — a noon-only measurement hid a 6k overage for a whole round; typecheck/lint clean; every visual change is judged from a screenshot.
