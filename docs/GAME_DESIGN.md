...
Acceptance: screenshots at hours 12, 18.7, 22 look right (windows lit at night, neon on, lamps with light pools, sunset gradient); static draws ≈ 52 and the whole frame < 120 draw calls at noon, noon triangles ≤ ~720k; typecheck/lint clean; every visual change is judged from a screenshot.
