// Main menu over the live cinematic city: title + tagline, Başla / Kontroller / Ayarlar. Track D.
...
export default function MainMenu({ onControls, onSettings }: { onControls: () => void; onSettings: () => void }) {
  ...
  return (
    <MenuShell>
      ...
      <GameTitle />
      <p className="text-sm uppercase tracking-[0.35em] text-white/70">Sahil · Neon · Gece Sürüşü</p>
      ...
      <div className="absolute bottom-4 right-5 text-[11px] uppercase tracking-[0.3em] text-white/40">Sürüm 1</div>
      <div className="absolute bottom-4 left-5 text-[11px] uppercase tracking-[0.3em] text-white/40">WASD sür · E bin/in · Boşluk el freni</div>
    </MenuShell>
  );
}
